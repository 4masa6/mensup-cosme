...
<img width="1356" alt="05  レビュー詳細表示" src="https://user-images.githubusercontent.com/70381096/96372130-7f1d5380-11a0-11eb-9835-726301c51a36.png">
...
- 実際の開発現場でのタスクの進め方をイメージし、実践に近い形で開発を進めた
  - GitHubで機能実装ごとにブランチ作成。作業ごとにできるだけ細かくコミットし、プッシュ。
